...
const WEBSITE_PIN = "2705";              // ← GANTI PIN

/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   2. NAMA PENERIMA
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Nama yang muncul di halaman utama (hero).                      */
const RECIPIENT_NAME = "Izzabelle";           // ← GANTI NAMA
...
"HAIII SAYANGGGGGG, selamat satuu bulannn yaaaa 🤍",
"I just wanted to take a moment to write this down for you, because sometimes simple words aren't enough to express how deeply grateful I am to have you in my life. First of all, thank you. Terimakasih banyak ya udah hadir di hidupku. I know it’s only been a month, tapi jujur, rasanya kayak semesta jauh lebih indah dan damai sejak ada kamu. You’ve brought so much light, laughter, and warmth into my days. Kamu bener-bener membuat hidupku jauh lebih berarti, and I mean every single word. Knowing that I have you makes me look forward to every new day.",
"Aku sadar betul kalau aku masih jauh dari kata sempurna. I might not be the most romantic person you’ve ever met, dan kadang aku masih sering bingung harus gimana. Tapi sayangg, aku bakal selalu berproses dan berusaha keras untuk jadi pasangan yang terbaik buat kamu. Aku mau terus belajar, jadi tolong bimbing dan bantu aku yaa untuk jadi orang yang lebih baik lagi ke depannya. Let's grow and improve together.",
"I know we are dealing with this distance right now, and I’m not gonna lie, LDR is never easy. Kangennya kadang suka datang tiba-tiba dan rasanya berat banget. Tapi di jarak yang memisahkan kita sekarang, aku minta tolong untuk selalu jaga hati kamu dan tetap setia sama apa yang kita punya. I know it gets lonely sometimes, tapi tolong, keep your heart exclusive for me, sebagaimana aku yang selalu menutup hati untuk orang lain dan cuma menyisakan ruang itu untuk kamu di sini. Let’s not let temporary loneliness ruin what we’re building. Distance means so little when someone means so much. Dan buat aku, kamu adalah segalanya. Jarak ini cuma jeda sebelum kita bisa terus bareng-bareng nanti.",
"Thank you for choosing me, thank you for loving me, and thank you for being my safest place. I love you more than words can say, and I’m so excited to see what the future holds for us. Happy 1st month, My Favorite Person. 🤍🤍🤍🤍🤍🤍",
...
const WISHES = [
  ...
  { icon: "heart",   text: "happy anniversary istg — cheers buat another year penuh memories yang bakal selalu worth keeping." },
];
...
const WHATSAPP_NUMBER = "6283874402897";   // ← GANTI NOMOR WA YANG ORDER
